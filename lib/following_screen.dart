...
void main() => runApp(FollowingScreen());
...
class FollowingScreen extends StatefulWidget {
  ...
  @override
  _FollowingScreenPageState createState() => _FollowingScreenPageState();
}

class _FollowingScreenPageState extends State<FollowingScreen> {
              ...
              Container(
                ...
                child: SingleChildScrollView(
                  ...
                  children: (objList1 != null)
                    ...
                    //                   image: NetworkImage(multimedia()
                    //                           .multimediaBaseUrl +
                    //                       objList1[index]['user']['coverPicture']),
                    //                 ),
                    //                 SizedBox(height: 50),
                    //                 Text(objList1[index]['user']['name']),
                    //                 Text("followed by " +
                    //                     objList1[index]['user']['followedBy']
                    //                         .toString() +
                    //                     " person"),
                    //                 SizedBox(height: 10),
                    //                 (objList1[index]['isFollowing'] == true)
                    //                     ? ElevatedButton(
